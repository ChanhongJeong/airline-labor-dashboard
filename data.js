  ...
  "countries": [
    ...
    },
    {
      ...
      "leavePolicyExtended": {
        ...
        "healthLeave": {
          "value": "임신 7개월 이상 근로자 야간·연장근로 금지, 1시간 휴식. 수유기(12개월) 매일 1시간 수유시간 유급",
          "legal": "여직원 노동보호 특별규정 제6·9조"
        },
        "sick": {
    ...
    },
    {
      ...
      "fixedTermContract": {
        "max": "무기계약 원칙. 기간제는 <strong>견습·시용·계절·대체근로·임시 프로젝트·재정 한정 업무</strong> 등 허용 사유에 한해 체결 가능",
        "conversion": "허용 사유로 체결된 계약이 만료 후에도 근로자가 계속 근무하면 <strong>동일 기간만큼 자동 연장 간주</strong>. 허용 사유 없이 체결된 기간제는 무기계약으로 간주 가능",
        "legalBasis": "노동법 제50조 제1항 각호, 제50조 제3항",
        "note": "⚠️ 계약서에 '유기계약임'과 '종료일' 명확 기재 필수. 기간 만료 시 사용자가 명시적 종료 의사를 밝히지 않으면 자동 연장 리스크. 반복 갱신 시 상시업무로 해석되어 무기계약 전환 가능"
      },
      "workRules": {
        "mandatory": true,
      ...
      "employmentType": {
        ...
        "fixedTermMax": {
          "value": "일반 기간제는 최대 1년 권장. 견습·시용·계절·대체근로·프로젝트·예산 한정 업무 등 허용 사유 시만 체결",
      ...
      "leavePolicyExtended": {
        ...
        "healthLeave": {
          "value": "임산부 산전검진·모유 수유 휴식 시간 보장 (근로시간 포함, 유급)",
          "legal": "노동법 제136조"
        },
        "sick": {
      ...
      "operatingGuide": {
        ...
        "fixedTermMaxGuide": {
          "value": "일반 사유로는 1년까지 가능 (반복 갱신 제한). 계약서에 '유기계약임'·'종료일' 명확 기재 필수",
          "legal": "노동법 제50조"
        },
        "probationGuide": {
    ...
    },
    {
      ...
      "leavePolicyExtended": {
        ...
        "healthLeave": {
          "value": "여성 근로자 생리휴가 월 30분씩 3일, 만 12개월 미만 자녀 양육 시 일 60분 근로시간 단축(유급)",
          "legal": "노동법 2019 제137조 제4항"
        },
        "sick": {
        ...
        "parental": {
          "value": "출산휴가 종료 후 추가 육아휴직 무급 (합의). 만 7세 미만 자녀 병가 시 간호휴가(25일/년)",
          "legal": "노동법 2019 제139조, 사회보험법 제27조"
        },
        "parentalFixedTerm": {
    ...
    },
    {
      ...
      "leavePolicyExtended": {
        ...
        "healthLeave": {
          "value": "임신 근로자 산전 검진·모유수유 시간 보장 (근로시간 포함)",
          "legal": "Labor Law 2013 제98조"
        },
        "sick": {
          "value": "사회보장기금에서 병가급여 지급. 의사 진단서 필요. 사용자는 단기(30일 이내) 유급 원칙",
          "legal": "Labor Law 2013 제50조, 사회보장법"
        },
        "parental": {
          "value": "법정 육아휴직 별도 명문 없음. 출산휴가 종료 후 복귀권 보장",
          "legal": "Labor Law 2013 제97조"
        },
        "parentalFixedTerm": {
