  ...
  "countries": [
    {
      ...
      "fixedTermContract": {
        "max": "단일 계약: <strong>일반 3년 / 전문직·60세+ 5년</strong> (노동기준법 §14)",
        "conversion": "누적 갱신 <strong>5년 초과</strong> 시 근로자 청구권으로 무기계약 전환 (노동계약법 §18, 2013.4.1 시행, 2018.4.1부터 청구권 최초 발생). 쿨링 6개월 이상 공백 시 누적 리셋",
        "legalBasis": "노동기준법 제14조 (단일 계약 상한) + 노동계약법 제18조 (5년 무기 전환 룰)",
        "note": "⚠️ 2가지 '5년' 구분 필수 — (1) <strong>단일 계약 상한 5년</strong>: 박사·공인회계사·의사·변호사·특정 실무경력 전문직 또는 만 60세 이상에 한정 / (2) <strong>무기전환 5년</strong>: 일반 근로자 전원 대상, 누적 갱신 기준. <strong>일반 사무직 주재원은 단일 계약 최대 3년</strong> → 갱신하면 누적 5년 초과 시점에 근로자가 무기 전환 청구 가능"
      },
      "workRules": {
        "mandatory": true,
        "threshold": "상시 10명 이상",
