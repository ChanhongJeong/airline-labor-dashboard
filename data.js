  ...
  "countries": [
    ...
    },
    {
      ...
      "detailedLabor": {
        ...
        "최대 연장시간": "일 최대 4시간·<strong>월 40시간·년 200시간</strong> (노동법 2019 §107). 특수 업종 년 300시간"
      },
      "wagePremiums": {
        "overtime": {
    ...
    },
    {
      ...
      "detailedLabor": {
        ...
        "최대 연장시간": "일 4시간 한도 (노동법 2021). 연간 총량은 단체협약"
      },
      "wagePremiums": {
        "overtime": {
          "formula": "<strong>평균임금</strong> × 150% 이상",
          "note": "연장근로 (1일 4시간 한도). 산정 기준: 시급이 아닌 <strong>평균임금(дундаж цалин)</strong> 기준 계산"
        },
        "night": {
          "formula": "<strong>평균임금</strong> × 120% 이상 (22:00~06:00)",
          "note": "야간근로. 평균임금 기준. 연장+야간 중복 시 각각 가산"
        },
        "restDay": {
          "formula": "<strong>평균임금</strong> × 200% 이상 또는 대체휴무",
          "note": "주휴일(통상 2일) 근무 시. 평균임금 기준"
        },
        "publicHoliday": {
          "formula": "<strong>평균임금</strong> × 200% 이상",
          "note": "⚠️ <strong>스케줄(교대) 근무자는 공휴일 할증 지급 의무 없음</strong> (정상 근무로 간주). 비스케줄 근무자만 200% 적용. 평균임금 기준 (현지 법률자문 확인)"
        }
      },
      "contractRequirements": [
        "업무 성격 및 직무",
      ...
      "annualLeave": {
        "statutory": "기본 15일 — 노동법 2021. 근속 가산: <strong>6~10년 +3일(18일) / 11~15년 +5일(20일) / 16~20년 +7일(22일) / 21~25년 +9일(24일) / 26~31년 +11일(26일) / 32년+ +14일(최대 29일)</strong>",
        "grantRule": "6개월 근속 후 발생. 18세 미만 20일. 파트타임 비례 (최소 10일). 유해·위험 직종 추가 가산",
        "compensation": {
          "required": true,
    ...
    },
    {
      ...
      "detailedLabor": {
        ...
        "최대 연장시간": "일 3시간·년 45일(약 135시간) 한도 (Labor Law §51). 근로자 동의 필수"
      },
      "wagePremiums": {
        "overtime": {
