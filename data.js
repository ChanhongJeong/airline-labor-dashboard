...
window.DASHBOARD_DATA = {
  ...
  "countries": [
    ...
    },
    {
      ...
      "hiringPlaybook": {
        "standardPath": "<strong>현지인 채용 디폴트 = 정규직 무기계약</strong>. 한국식 '계약직→정규직 전환' 문화 없음. 계약사원은 프로젝트·성수기·신규노선 등 특수 사유 시만 사용. 60세+ 재고용은 촉탁 5년 단일 계약 가능. 3가지 형태: ① 정규직(무기·사회보험 전면가입·상여·승진) ② 계약사원(유기·§14 3년 한도·§18 누적 5년 무기전환) ③ 촉탁(정년 후 재고용·5년 계약 가능·급여 60~70%)",
      ...
      "employmentType": {
        "contractType": {
          "value": "<strong>무기계약 원칙</strong> — 일본 채용 디폴트. 3가지 형태: ① 정규직(무기·사회보험 전면가입·상여·승진) ② 계약사원(유기·단일 3년 한도·누적 5년 무기전환) ③ 촉탁(정년 후 재고용·5년 단일 계약 가능·급여 60~70%). 한국식 '계약직 → 정규직 전환' 문화 없음 — 정규직 채용이 디폴트",
        ...
        "fixedTermMax": {
          "value": "단일 계약: <strong>일반 3년 / 전문직·60세+ 5년</strong>. 누적 갱신 5년 초과 시 근로자 청구권으로 무기 전환 (2018.4~ 청구권 최초 발생). 쿨링 6개월 이상 공백 시 누적 리셋 (단 탈법 판정 리스크)",
          "legal": "노동기준법 제14조 + 노동계약법 제18조"
        },
        "foreignerLimit": {
