    ...
    },
    {
      ...
      "annualLeave": {
        ...
        "compensation": {
          ...
          "note": "연차는 휴식권이라는 취지로 근로 중 매수(연차의 금전 환산)는 법 위반"
        },
        "carryover": {
          "allowed": true,
          "maxYears": "1년 (소멸시효 2년)",
        ...
        "specialObligation": "⚠️ 연 5일 이상 취득 의무 (2019.4~, 일하는 방식 개혁) - 사용자가 시기 지정해서라도 5일 사용시켜야 함. 미이행 시 근로자 1인당 최대 30만엔 벌금. 시간 단위 분할 사용은 노사협정 체결 시 연 5일 한도 가능",
        "tip": "실무상 유급휴가 소진 관리가 엄격. 연 5일 의무 취득 체크 + 이월분 소멸 전 통보 필수. 결혼·근친자 사망·배우자 출산 시 별도 유급 경조휴가는 회사 관습(법정 의무 아님)"
      },
      "employmentType": {
        "contractType": {
      ...
      "yearOverrides": {
        ...
        "2019": {
          "annualLeave": {
            ...
            "consent": "자동 이월 (별도 동의서 불필요)",
            "specialObligation": "⚠️ <strong>연 5일 이상 취득 의무 2019.4.1 시행</strong> (일하는 방식 개혁) - 사용자가 시기 지정해서라도 5일 사용시켜야 함",
