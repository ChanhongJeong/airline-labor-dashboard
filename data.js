  ...
  "countries": [
    ...
    },
    {
      ...
      "employmentType": {
        ...
        "probation": {
          "value": "계약 3M~1Y 수습 최대 1M / 1~3Y 최대 2M / 3Y+ 또는 무고정 최대 6M. 수습 임금 정식의 80% 이상",
          "legal": "노동계약법 제19·20조"
        },
        "fixedTermMax": {
      ...
      "leavePolicyExtended": {
        "maternity": {
          "value": "국가 98일 + 성별 추가(대부분 성 60~90일) = 총 158~190일 유급. 난산 +15일, 쌍둥이 +15일/태아",
          "legal": "여직원 노동보호 특별규정(2012) 제7조, 인구계획생육법"
        },
        "paternity": {
          "value": "성별 상이 — 통상 배우자 출산 시 10~30일 유급 (베이징 15일, 상하이 10일, 광둥 15일)",
      ...
      "operatingGuide": {
        "workRulesObligation": {
          "value": "규장제도(规章制度) 작성 의무. 직공대표대회·전체회의 의견청취 + 공시(공고·교부·통보) 필수. 미공시 시 효력 제한·불리 해석",
          "legal": "노동계약법 제4조"
        },
        "fixedTermMaxGuide": {
        ...
        "probationGuide": {
          "value": "계약 3M~1Y → 최대 1M / 1~3Y → 최대 2M / 3Y+ or 무고정 → 최대 6M. 동일 사용자 수습 1회만 가능. 수습 임금 정식 80%+ 또는 최저임금+",
          "legal": "노동계약법 제19·20조"
        },
      ...
      "koreanWorkerNotes": {
        "applicable": true,
        "socialInsurance": "외국인 5대 사회보험 원칙 의무 (사회보험법 2011.10.28 부령). 한-중 사회보장협정(2013~)으로 양로·실업 면제 가능 — '참가증명서' 필요. 의료·산재·생육은 납부",
    ...
    },
    {
      ...
      "labor": [
        ...
        "최대 연장: 일 최대 4시간·<strong>월 40시간·년 200시간</strong> (노동법 2019 §107). 특수..."
      ],
      "detailedLabor": {
        ...
        "사회보험": "사용자 21.5% + 근로자 10.5% (연금·건강·실업·산재·질병/출산). 사회보험법 2024 (2025.7.1 시행)",
        "외국인 고용": "노동허가서(Work Permit) 필수. DT/LD 비자 + TRC. 최대 2년, 갱신 가능 (노동법 제151~155조, 정부령 152/2020/ND-CP)",
      ...
      "wagePremiums": {
        ...
        "night": {
          "formula": "시급 × 130% 이상 (야간 기본급 30% 가산)",
          "note": "야간 22:00~06:00. 야간+연장 중복 시 연장수당에 추가 20% 가산 (총 200% 이상)",
          "legal": "노동법 2019 제98조 제2·3항"
        },
        "restDay": {
          "formula": "시급 × 200% 이상",
          "note": "주휴일(통상 일요일) 근무. 정상 일급은 별도 지급 안 됨",
      ...
      "employmentType": {
        ...
        "foreignerLimit": {
          "value": "Work Permit + DT/LD 비자 필수 (최대 2년, 갱신 가능). 임원급·주주·30일 미만 파견 등 일부 면제",
          "legal": "노동법 제151~155조, 정부령 152/2020/ND-CP"
        }
      },
      "workingHours": {
        "daily": {
      ...
      "leavePolicyExtended": {
        ...
        "sick": {
          "value": "사회보험에서 근속별 병가급여: 30년 미만 30일/년, 30년 이상 40일/년, 중증·장애 60일/년 (평균임금 75%)",
          "legal": "사회보험법 제24~28조"
        },
        "parental": {
          "value": "❌ 정식 육아휴직 명문 규정 없음 — 출산휴가 종료 후 추가 무급 휴가는 노사 합의. 만 7세 미만 자녀 병가 시 '자녀 간호휴가' 연 25일(사회보험 지급)",
          "legal": "육아휴직: 명문 없음 / 자녀 간호휴가: 사회보험법 제27조"
        },
        "parentalFixedTerm": {
      ...
      "compensation": {
        "socialInsurance": {
          ...
          "legal": "사회보험법 2024 (2025.7.1 시행), 건강보험법, 실업보험법",
          "note": "외국인은 실업보험 미가입 (베트남 국민 전용)"
        },
        "thirteenthMonth": {
      ...
      "koreanWorkerNotes": {
        "applicable": true,
        "socialInsurance": "⚠️ 외국인 사회·의료보험 의무 (2018~) — 사회보험법 2024 시행 이후 강화. <strong>실업보험은 베트남 국민 전용</strong>, 한국인 가입 불가 → 실업급여·퇴직금 대체 불가",
        ...
        "visa": "노동허가서(Work Permit) 최대 2년, 갱신 가능 (정부령 152/2020/ND-CP). 허가 전 근로 금지 (벌금 최대 VND 75M + 출국 명령)",
        "employmentQuota": "외국인 사용 사전 인가 필요 — 성/시 노동국에 채용계획(30일 전) + 인력 수요 광고(30일 이상) 의무. 베트남인 대체 가능 직무는 외국인 고용 제한. 전문직·관리직 중심으로 허가",
        "employmentQuotaLegal": "노동법 제152조, 정부령 152/2020/ND-CP 제4·5조"
      },
      "thirteenthMonth": {
        "status": "관행 (사실상 표준)",
      ...
      "expatriateCompliance": {
        ...
        "workVisa": "<strong>Work Permit → DT(투자자)/LD(노무) 비자 → 임시거류증(TRC)</strong> 순차. Work Permit 최대 2년, 갱신 가능. <strong>⚠️ 허가 전 근로 금지</strong>(VND 75M 벌금 + 출국). 절차: 의료검진→학위인증(영사확인)→범죄경력→WP→비자→TRC (2~3개월)",
        "workVisaLegal": "노동법 제151~155조, 정부령 152/2020/ND-CP, 외국인출입국법 제47조",
